...
Call log:
  - waiting for locator('a[href], .menu-item, li a, nav a').first()
    - locator resolved to <a href="#" role="button" class="nav-link" data-widget="pushmenu">…</a>
  - attempting click action
    2 × waiting for element to be visible, enabled and stable
      - element is visible, enabled and stable
      - scrolling into view if needed
      - done scrolling
      - <div class="modal-content">…</div> from <div class="content-wrapper">…</div> subtree intercepts pointer events
